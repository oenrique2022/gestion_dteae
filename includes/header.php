...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="/dashboard">
            <i class="bi bi-house-door-fill"></i> Gestión Administrativa DTEAE.
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="../usuarios/listar_usuarios.php">
                        <i class="bi bi-people-fill"></i> Lista de usuario
                    </a>
                </li>
                <!--li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../tipo_equipos/gestion.php">
                        <i class="bi bi-grid-3x3-gap-fill"></i> Categorías
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../equipos/gestion.php">
                        <i class="bi bi-pc-display"></i> Tecnologías
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../proveedores/gestion.php">
                        <i class="bi bi-truck"></i> Proveedores
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../contratos/gestion.php">
                        <i class="bi bi-file-earmark-text-fill"></i> Contratos
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../entregas/gestion.php">
                        <i class="bi bi-box2-fill"></i> Entregas
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../capacitaciones/gestion.php">
